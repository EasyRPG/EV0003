# -*- coding: utf8 -*-
"""
version.py - EV0003 Version Plugin (based on Sopel's)
Copyright 2009, Silas Baronda
Copyright 2014, Dimitri Molenaars <tyrope@tyrope.nl>
Copyright 2021, carstene1ns <dev @ f4ke . de>

This customized sopel plugin is part of EV0003
(keep in sync with sopel/modules/version.py)
...
# CT: this plugins lives one directory less deep
...
def ctcp_version(bot, trigger):
    ...
    bot.write(('NOTICE', trigger.nick),
              #CT: Show our version instead of Sopel's
              '\x01VERSION EV0003 IRC Bot hash %.12s\x01' % ver)
...
def ctcp_source(bot, trigger):
    bot.write(('NOTICE', trigger.nick),
              # CT: Show own source instead of Sopel's
              '\x01SOURCE https://github.com/EasyRPG/EV0003\x01')
